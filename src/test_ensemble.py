from tools.eval import evaluate, eval_ennsemble
...
def main():
    df = pl.read_csv("datasets/preprocessed_dataset.csv")
    ...
    f1, jaccard, hamming = eval_ennsemble(test_df, target_list_path)
    print(f"F1 Score: {f1}")
